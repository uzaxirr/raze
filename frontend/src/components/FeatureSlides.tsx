...
const slides: SlideData[] = [
  {
    headline: "Full portfolio\nautopsy",
    query: '"scan my wallet"',
    queryColor: "#9945FF",
    description: "SOL, tokens, dust attacks, stale positions, total value. raze finds the $540 in forgotten cNFTs you didn't know you had.",
    bgColor: "#EDE8FF",
    ghostPosition: "left",
  ...
  },
  {
    ...
    query: '"is $WIF safe?"',
    queryColor: "#CC0000",
    description: "mint authority, LP status, holders, bundles — full security scan in one message. 98.7% of pump.fun tokens are rugs. check before you ape.",
    bgColor: "#FFE0E0",
    ghostPosition: "right",
  ...
  {
    headline: "Full token\nautopsies",
    query: '"full dyor on $POPCAT"',
    queryColor: "#14A86C",
    description: "security, holders, sentiment, whale activity, dev wallet — all cross-referenced in one answer. with an actual opinion, not just data.",
    bgColor: "#DFFFF0",
    ghostPosition: "top",
  ...
  {
    headline: "Snipe new\ntokens",
    query: '"find me gems under $500k mcap"',
    queryColor: "#14A86C",
    description: "fresh tokens filtered for safety. mcap, holders, bundle risk, momentum score — skip the rugs, find the plays.",
    bgColor: "#DFFFF0",
    ghostPosition: "right",
  ...
  {
    headline: "Market\nsentiment",
    query: '"what does CT think about SOL?"',
    queryColor: "#9945FF",
    description: "social buzz, whale sentiment, news — distilled into one take with an actual opinion. skip the timeline. raze tells you what crypto twitter actually thinks.",
    bgColor: "#E8E0FF",
    ghostPosition: "left",
